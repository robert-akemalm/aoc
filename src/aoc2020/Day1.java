...
public class Day1 {
    ...
    private static void b(String input) {
        long[] expenses = input.lines().mapToLong(Long::parseLong).toArray();
    ...
    private static void a(String input) {
        int[] expenses = input.lines().mapToInt(Integer::parseInt).toArray();
        for (int i = 0; i < expenses.length; i++) {
            for (int j = i+1; j < expenses.length; j++) {
    ...
    private static final String INPUT = "1539\n"
                                        + "1914\n"
                                        + "1866\n"
                                        + "1407\n"
                                        + "1706\n"
